...
window.customCards.push({ type: "aibox-webui-card", name: "AI BOX WebUI Card", description: "Full-featured AI BOX control card", preview: false });
    ...
    if (stored !== BUILD_TS) {
      ...
      if (stored !== null && 'caches' in window) {
        caches.keys().then(keys => {
          ...
          console.warn("[AI BOX Card] Cache cleared — reloading for new build:", BUILD_TS);
